...
# checkpointer = ModelCheckpoint(filepath="/model/tmp_weights.hdf5", verbose=1, save_best_only=True)

# weights.{epoch:02d}-{val_loss:.2f}.hdf5
checkpointer = ModelCheckpoint(filepath="tmp/weights.{epoch:02d}-{val_loss:.2f}.h5", verbose=1, save_best_only=False)
